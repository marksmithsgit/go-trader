...
@RequiresFullAccess
public class NZDUSD_HistoricalBarRequester implements IStrategy {
    ...
    public String requestQueueName = "NZDUSD_H-Requests";
    public String responseQueueName = "NZDUSD_H-Bars";
    ...
    private static final Instrument INSTRUMENT = Instrument.NZDUSD;
    ...
    public void onStart(IContext context) throws JFException {
        ...
        console.getOut().println("Starting NZDUSD_HistoricalBarRequester strategy...");
    ...
    public void onStop() throws JFException {
        startupTimer.cancel();
        console.getOut().println("Stopping NZDUSD_HistoricalBarRequester strategy...");
