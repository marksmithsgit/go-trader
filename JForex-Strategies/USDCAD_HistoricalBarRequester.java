...
@RequiresFullAccess
public class USDCAD_HistoricalBarRequester implements IStrategy {
    ...
    public String requestQueueName = "USDCAD_H-Requests";
    public String responseQueueName = "USDCAD_H-Bars";
    ...
    private static final Instrument INSTRUMENT = Instrument.USDCAD;
    private static final int PAIR_ID = 6;
    ...
    public void onStart(IContext context) throws JFException {
        ...
        console.getOut().println("Starting USDCAD_HistoricalBarRequester strategy...");
    ...
    public void onStop() throws JFException {
        startupTimer.cancel();
        console.getOut().println("Stopping USDCAD_HistoricalBarRequester strategy...");
