...
@RequiresFullAccess
public class USDJPY_HistoricalBarRequester implements IStrategy {
    ...
    public String requestQueueName = "USDJPY_H-Requests";
    // // @Configurable(value = "Response/Data Queue Name")
    public String responseQueueName = "USDJPY_H-Bars";
    ...
    public void onStart(IContext context) throws JFException {
        ...
        console
            .getOut()
            .println("Starting USDJPY_HistoricalBarRequester strategy...");
    ...
    public void onStop() throws JFException {
        ...
        console
            .getOut()
            .println("Stopping USDJPY_HistoricalBarRequester strategy...");
