...
@RequiresFullAccess
public class GBPUSD_HistoricalBarRequester implements IStrategy {
    ...
    public String requestQueueName = "GBPUSD_H-Requests";
    // // @Configurable(value = "Response/Data Queue Name")
    public String responseQueueName = "GBPUSD_H-Bars";
    ...
    private static final Instrument INSTRUMENT = Instrument.GBPUSD;
    private static final int PAIR_ID = 3;
    ...
    public void onStart(IContext context) throws JFException {
        ...
        console
            .getOut()
            .println("Starting GBPUSD_HistoricalBarRequester strategy...");
    ...
    public void onStop() throws JFException {
        ...
        console
            .getOut()
            .println("Stopping GBPUSD_HistoricalBarRequester strategy...");
