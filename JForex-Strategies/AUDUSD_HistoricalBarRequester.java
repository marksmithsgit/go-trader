...
@RequiresFullAccess
public class AUDUSD_HistoricalBarRequester implements IStrategy {
    ...
    public String requestQueueName = "AUDUSD_H-Requests";
    public String responseQueueName = "AUDUSD_H-Bars";
    ...
    private static final Instrument INSTRUMENT = Instrument.AUDUSD;
    private static final int PAIR_ID = 5;
    ...
    public void onStart(IContext context) throws JFException {
        ...
        console.getOut().println("Starting AUDUSD_HistoricalBarRequester strategy...");
    ...
    public void onStop() throws JFException {
        startupTimer.cancel();
        console.getOut().println("Stopping AUDUSD_HistoricalBarRequester strategy...");
