...
@RequiresFullAccess
public class EURGBP_BarDataFeeder implements IStrategy {
    ...
    // Queue name is now instrument-specific, e.g., "EURGBP_Market_Data_Bars"
        private static final String AMQP_QUEUE_NAME = INSTRUMENT.name() + "_Market_Data_Bars";
