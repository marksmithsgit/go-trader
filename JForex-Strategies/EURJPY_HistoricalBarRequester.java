...
@RequiresFullAccess
public class EURJPY_HistoricalBarRequester implements IStrategy {
    ...
    public String requestQueueName = "EURJPY_H-Requests";
    public String responseQueueName = "EURJPY_H-Bars";
    ...
    private static final Instrument INSTRUMENT = Instrument.EURJPY;
    private static final int PAIR_ID = 8;
    ...
    public void onStart(IContext context) throws JFException {
        ...
        console.getOut().println("Starting EURJPY_HistoricalBarRequester strategy...");
    ...
    public void onStop() throws JFException {
        startupTimer.cancel();
        console.getOut().println("Stopping EURJPY_HistoricalBarRequester strategy...");
