...
@RequiresFullAccess
public class EURGBP_HistoricalBarRequester implements IStrategy {
    ...
    public String requestQueueName = "EURGBP_H-Requests";
    public String responseQueueName = "EURGBP_H-Bars";
    public int defaultBarsCount = 200;

    private static final Period[] REQUEST_PERIODS = {Period.TEN_SECS, Period.ONE_MIN, Period.FIVE_MINS, Period.FIFTEEN_MINS, Period.ONE_HOUR, Period.FOUR_HOURS, Period.DAILY};
    private static final Instrument INSTRUMENT = Instrument.EURGBP;
    private static final int PAIR_ID = 10;

    private static final int[] DEMA_PERIODS = {25, 50, 100, 200};
    private static final int MACD_FAST_PERIOD = 12, MACD_SLOW_PERIOD = 26, MACD_SIGNAL_PERIOD = 9;
    ...
    private static final int RSI_FAST_PERIOD = 7, RSI_SLOW_PERIOD = 21;
    private static final int STOCH_K_PERIOD = 14, STOCH_K_SLOW_PERIOD = 3, STOCH_D_PERIOD = 3;
    private static final int CCI_PERIOD = 20, MFI_PERIOD = 14;
    private static final int INDICATOR_HISTORY_BUFFER = 250;
    ...
    public void onStart(IContext context) throws JFException {
        ...
        console.getOut().println("Starting EURGBP_HistoricalBarRequester strategy...");
    ...
    public void onStop() throws JFException {
        startupTimer.cancel();
        console.getOut().println("Stopping EURGBP_HistoricalBarRequester strategy...");
    ...
    private void scheduleStartupFetch() {
        console.getOut().println("Scheduling initial bar fetch for " + INSTRUMENT.name() + " in 5 seconds...");
        startupTimer.schedule(new TimerTask() {
            @Override
            public void run() {
                console.getOut().println("Executing scheduled startup fetch for " + INSTRUMENT.name() + "...");
                try {
                    context.executeTask((Callable<Void>) () -> {
                        fetchAndSendHistoricalBars(INSTRUMENT, defaultBarsCount);
                        return null;
                    });
                } catch (Exception e) {
    ...
    private void calculateAndSendBars(Instrument instrument, Period period, List<IBar> allBidBars, List<IBar> allAskBars, int barsToSend) throws JFException, IOException {
        ...
        for (int i = startIdx; i < historySize; i++) {
            ...
            String jsonMessage = formatBarToJson(instrument, period, askBar, bidBar, bidTi, askTi, sequence, i);
    ...
    private String formatBarToJson(Instrument instrument, Period period, IBar askBar, IBar bidBar, TechnicalIndicators bidTi, TechnicalIndicators askTi, int sequence, int index) {
        ...
        json.append(",\"bid_vwap\":{\"tick_vwap\":null}");
        ...
        json.append(",\"ask_vwap\":{\"tick_vwap\":null}");
