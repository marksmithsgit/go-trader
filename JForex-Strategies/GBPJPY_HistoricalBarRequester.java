...
@RequiresFullAccess
public class GBPJPY_HistoricalBarRequester implements IStrategy {
    ...
    public String requestQueueName = "GBPJPY_H-Requests";
    public String responseQueueName = "GBPJPY_H-Bars";
    ...
    private static final Instrument INSTRUMENT = Instrument.GBPJPY;
    private static final int PAIR_ID = 9;
    ...
    public void onStart(IContext context) throws JFException {
        ...
        console.getOut().println("Starting GBPJPY_HistoricalBarRequester strategy...");
    ...
    public void onStop() throws JFException {
        startupTimer.cancel();
        console.getOut().println("Stopping GBPJPY_HistoricalBarRequester strategy...");
