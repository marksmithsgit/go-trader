...
@RequiresFullAccess
public class USDCHF_HistoricalBarRequester implements IStrategy {
    ...
    public String requestQueueName = "USDCHF_H-Requests";
    public String responseQueueName = "USDCHF_H-Bars";
    ...
    private static final Instrument INSTRUMENT = Instrument.USDCHF;
    private static final int PAIR_ID = 4;
    ...
    public void onStart(IContext context) throws JFException {
        ...
        console.getOut().println("Starting USDCHF_HistoricalBarRequester strategy...");
    ...
    public void onStop() throws JFException {
        startupTimer.cancel();
        console.getOut().println("Stopping USDCHF_HistoricalBarRequester strategy...");
    ...
    private void handleCommand(String jsonCommand) {
        try {
            ...
            int barsCount = Integer.parseInt(
                commandMap.getOrDefault("barsCount", String.valueOf(defaultBarsCount))
            );
